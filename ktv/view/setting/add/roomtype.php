...
if(!isset($_GET['flag']) || $_GET['flag'] != 1){
    header("Location: /ktv/view/setting/list/roomtype.php");
}
?>
<html>
<head>
            ...
            <form onsubmit=addRoomType()>
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="name" name="name" placeholder="房型名" value="" required>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-item-title">
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="capacity" name="capacity"  placeholder="最大容纳人数" value="" required>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-item-title">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="annotation" name="annotation" placeholder="备注" value="">
                    </div>
                </div>
                <!--按钮栏目-->
