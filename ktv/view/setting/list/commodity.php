...
<body>
    ...
    <div class="content-container">
        <div class="content">
            <!--搜索-->
            <div class="search">
                <form action="commodity.php" method="get">
                    <!--搜索框-->
                    <div class="search-filed">
                        ...
                        <div class="filed">
                            ...
                            <div class="filed-input">
                                <input type="text" id="name" name="name" placeholder="商品名称" value="<?php echo isset($_GET['id'])?$_GET['name']:"";?>">
                            </div>
                        </div>
                        <div class="filed">
                            <div class="filed-title">
                            ...
                            <div class="filed-input">
                                <select name="cateId" id="cateId">
                                    ...
                                    ?>
                                    <option value="<?php echo $category['id']?>" <?php echo isset($_GET['cateId'])&&$_GET['cateId']==$category['id']?"selected":""?>><?php echo $category['name']?></option>
                                    <?php
                                        }
                                        ?>
                                </select>
                    ...
                    <div class="search-button">
                        ...
                        <input type="button" id="search-reset" value="重置" onclick=resetListCommoditySearch()>
                    </div>
                </form>
            </div>
            <!--表格-->
            <div class="result">
                ...
                <table>
                    <?php
                        ...
                        $items = $commodityDao->getCommodityByKey($_GET['id'],$_GET['name'],$_GET['cateId']);
                    ?>
                    <tr id="table-title">
                        <td>ID</td>
                        <td>商品</td>
                    ...
                    <tr id="table-item">
                        ...
                        <td>
                            <button class="bt-normal" onclick=openCommodityDetail(<?php echo $item['id']?>)>修改</button>
                            <button class="bt-delete" onclick=deleteCommodity(<?php echo $item['id']?>)>删除</button>
                        </td>
                    </tr>
                    <?php
                    }
