...
<body>
    ...
    <div id="menu" class="menu">
        <div class="menu-item">
            <ul>
                ...
                <a href="<?php echo LIST_PATH."roomtype.php"?>"><li id="menu-item-select">房型管理</li></a>
    ...
    <div class="content-container">
        <div class="content">
            <!--搜索-->
            <div class="search">
                <form action="roomtype.php" method="get">
                    <!--搜索框-->
                    <div class="search-filed">
                        ...
                        <div class="filed">
                            ...
                            <div class="filed-input">
                                <input type="text" id="roomtype" name="roomtype" placeholder="房型" value="<?php echo isset($_GET['roomtype'])?$_GET['roomtype']:"";?>">
                            </div>
                        </div>
                        <div class="filed">
                            <div class="filed-title">
                    ...
                    <div class="search-button">
                        ...
                        <input type="button" id="search-reset" value="重置" onclick=resetListRoomTypeSearch()>
                    </div>
                </form>
            ...
            <div class="result">
                <div class="result-bt">
                    <a href="<?php echo ADD_PATH."roomtype.php?flag=1"?>">
                ...
                <table>
                    ...
                    $items=$roomTypeDao->getRoomtypeByKey($_GET['id'],$_GET['roomtype'],$_GET['capacity']);
                    ?>
                    <tr id="table-title">
                        <td>ID</td>
                        <td>房型</td>
                    ...
                    <tr id="table-item">
                        ...
                        <td id="roomnum-<?php echo $item['id']?>"><?php echo $item['num']?></td>
                        <td>
                            <button class="bt-normal" onclick=openRoomTypeDetail(<?php echo $item['id']?>)>查看</button>
                            <button class="bt-normal" onclick=openRoomTypeDetail(<?php echo $item['id']?>)>修改</button>
                            <button class="bt-delete" onclick=deleteRoomtype(<?php echo $item['id']?>)>删除</button>
                        </td>
                    </tr>
                    <?php
                    }
