...
//判断get中是否有id
if(!isset($_GET['id'])){
    header("Location:".LIST_PATH."room.php");
}
//获取id
$id = $_GET['id'];
$roomDao = new RoomDao();
$item = $roomDao->getRoomById($id)[0];
?>
<html>
<head>
    <title>设置</title>
            ...
            <form onsubmit=updateRoom()>
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="id" name="id" placeholder="房间ID" value="<?php echo $item['id']?>" disabled>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-item-title">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="name" name="name" placeholder="房型名" value="<?php echo $item['name']?>" required>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-item-title">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="floor" name="floor" placeholder="楼层" value="<?php echo $item['floor']?>" required>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-item-title">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="state" name="state" placeholder="状态" value="<?php echo $item['state']==1?"空闲":"使用中"?>" disabled>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-item-title">
                    ...
                    <div class="detail-item-field">
                        <select name="typeId" id="typeId">
                            ...
                            foreach($roomTypes as $roomType){
                                ?>
                                <option value="<?php echo $roomType['id']?>" <?php if($item['type_id']==$roomType['id']) echo "selected"?>><?php echo $roomType['name']?></option>
                                <?php
                            }
                            ?>
                        </select>
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="capacity" name="capacity" placeholder="状态" value="<?php echo $item['capacity']?>" disabled>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-item-title">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="annotate" name="annotate" placeholder="备注" value="<?php echo $item['annotate']?>">
                    </div>
                </div>
                <!--按钮栏-->
