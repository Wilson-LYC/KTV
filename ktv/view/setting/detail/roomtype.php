...
//判断get中是否有id
if(!isset($_GET['id'])){
    header("Location:".LIST_PATH."roomtype.php");
}
//获取id
$id = $_GET['id'];
$roomTypeDao = new RoomTypeDao();
$item = $roomTypeDao->getRoomTypeById($id);
if(count($item) == 0){
    header("Location:".LIST_PATH."roomtype.php");
}
$item=$item[0];
            ...
            <form onsubmit=updateRoomType()>
                <div class="detail-item">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="id" name="id" placeholder="房型ID" value="<?php echo $item['id']?>" disabled>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-item-title">
                ...
                <div class="detail-item">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="price" name="price" placeholder="价格" value="<?php echo $item['price']?>" required>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-item-title">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="capacity" name="capacity"  placeholder="最大容纳人数" value="<?php echo $item['capacity']?>" required>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-item-title">
