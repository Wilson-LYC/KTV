...
//判断get中是否有id
if(!isset($_GET['id'])){
    header("Location:".LIST_PATH."user.php");
}
//获取id
$id = $_GET['id'];
$userDao=new UserDao();
            ...
            <form onsubmit=updateUser()>
                <div class="detail-item">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="id" name="id" placeholder="用户编号" value="<?php echo $user['id']?>" disabled>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-item-title">
                    ...
                    <div class="detail-item-field">
                        <input type="text" id="name" name="name" placeholder="用户名" value="<?php echo $user['name']?>" disabled>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-item-title">
                    ...
                    <div class="detail-item-field">
                        <input type="password" id="password" name="password" placeholder="密码" value="<?php echo $user['password']?>" required>
                    </div>
                </div>
                <div class="detail-item">
                    <div class="detail-item-title">
                    ...
                    <div class="detail-item-field">
                        <select name="group" id="group">
                            ...
                            foreach($groups as $group){
                                ?>
                                <option value="<?php echo $group['id']?>" <?php if($user['groupId']==$group['id']) echo "selected"?>><?php echo $group['name']?></option>
                                <?php
                            }
                            ?>
                        </select>
